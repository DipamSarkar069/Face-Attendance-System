...
class App:
    def __init__(self):
        ...
        self.register_new_user_button_main_window = util.get_button(self.main_window, 'Click Photo and Register', 'gray',
    ...
    def login(self):
        ...
        output = str(subprocess.check_output(['face_recognition', self.db_dir, unknown_image_path]))
    ...
    def register_new_user(self):
        ...
        self.register_new_user_window.geometry("1200x520+150+100")
        ...
        self.entry_text_register_new_user.place(x=780, y=150)

        self.text_label_register_new_user = util.get_text_label(self.register_new_user_window,
                                                                'Please, \nInput username:')
        self.text_label_register_new_user.place(x=780, y=70)
